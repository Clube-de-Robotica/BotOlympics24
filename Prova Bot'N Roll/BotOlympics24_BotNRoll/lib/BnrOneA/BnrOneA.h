...
#define COMMAND_LINE_CALIB		0xE7 //Calibrate line 
...
#define COMMAND_ARDUINO_DIG3	0xB8 //Read digital3 value aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa  magnet
...
class BnrOneA
{
  public:
        ...
        void resetEncL();
        void resetEncR();
		void sendCalibrate(int valMax[],int valMin[],int trans);

        //teste bot2024
        void magnet(boolean state);
